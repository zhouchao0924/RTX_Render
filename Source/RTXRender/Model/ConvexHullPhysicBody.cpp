...
//{
//	VertexIndexData.Add(FVector(box.Min.X, box.Min.Y, box.Min.Z));
//	VertexIndexData.Add(FVector(box.Min.X, box.Min.Y, box.Max.Z));
//	VertexIndexData.Add(FVector(box.Max.X, box.Min.Y, box.Max.Z));
//	VertexIndexData.Add(FVector(box.Max.X, box.Min.Y, box.Min.Z));
//
//	VertexIndexData.Add(FVector(box.Min.X, box.Max.Y, box.Min.Z));
//	VertexIndexData.Add(FVector(box.Min.X, box.Max.Y, box.Max.Z));
//	VertexIndexData.Add(FVector(box.Max.X, box.Max.Y, box.Max.Z));
//	VertexIndexData.Add(FVector(box.Max.X, box.Max.Y, box.Min.Z));
//
//	int32 TriIdexArr[36] = { 0,1,2,0,2,3,2,3,7,2,7,6,4,5,6,4,6,7,0,1,5,0,5,4,1,2,6,1,6,5,0,3,7,0,7,4 };
//	for (int i = 0; i < 36; ++i)
//	{
//		TrignleIndexData.Push(TriIdexArr[i]);
//	}
//
//}